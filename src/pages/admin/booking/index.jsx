                    ...
                    <div className="overflow-x-auto rounded-xl border border-gray-200 mt-4">
                        <table className="min-w-full divide-y divide-gray-200">
                            <thead className="bg-gray-50 sticky top-0 z-10">
                                <tr>
                                    <th className="px-4 py-3 text-[14px] font-semibold text-gray-600 uppercase">Project Type</th>
                                    ...
                                    <th className="px-4 py-3 text-[14px] font-semibold text-gray-600 uppercase">Budget</th>
                                    <th className="px-4 py-3 text-[14px] font-semibold text-gray-600 uppercase">Finish Level</th>
                                    <th className="px-4 py-3 text-[14px] font-semibold text-gray-600 uppercase">Scope</th>
                                    ...
                                    <th className="px-4 py-3 text-[14px] font-semibold text-gray-600 uppercase">City</th>
                                    <th className="px-4 py-3 text-[14px] font-semibold text-gray-600 uppercase">Timeline</th>
                                    <th className="px-4 py-3 text-[14px] font-semibold text-gray-600 uppercase">Rate</th>
                                    <th className="px-4 py-3 text-[14px] font-semibold text-gray-600 uppercase">Subtotal</th>
                                    <th className="px-4 py-3 text-[14px] font-semibold text-gray-600 uppercase">Taxes</th>
                                    <th className="px-4 py-3 text-[14px] font-semibold text-gray-600 uppercase">Total Amount</th>
                                </tr>
                            </thead>
                                ...
                                {data.length > 0 ? (
                                    data.map((item) => (
                                        <tr key={item._id} className="hover:bg-gray-50">
                                            ...
                                            <td className="px-4 py-3 text-center">{item.finish_level}</td>
                                            <td className="px-4 py-3 text-center">{item.scope}</td>
